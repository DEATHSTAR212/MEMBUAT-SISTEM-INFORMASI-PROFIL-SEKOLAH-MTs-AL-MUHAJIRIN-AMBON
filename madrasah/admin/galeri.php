                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $p['keterangan']?></td>
                                        <td>
                                            <a href="edit-galeri.php?id=<?= $p['id'] ?>" title="Edit Data" class="text-black"><i class="fa fa-edit"></i>Edit</a> |
                                            <a href="hapus.php?idgaleri=<?= $p['id'] ?>" onclick="return confirm('yakin ingin menghapus akun tersebut?')" title="Hapus Data" class="text-red"><i class="fa fa-times"></i>Hapus</a>
                                        </td>
                                    </tr>
